	...
	frame.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if selectedPlayer == player then
				...
				-- Снимаем выделение с предыдущего выбранного игрока
				if selectedPlayerFrame then
					selectedPlayerFrame.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
					selectedPlayerFrame:FindFirstChildOfClass("Frame").Visible = false
				end
